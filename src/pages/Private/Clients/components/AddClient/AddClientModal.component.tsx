...
import { Container, Card, CardContent, Button, Grid, Typography, DialogTitle, Dialog, DialogContent, Stack, Box, IconButton, useTheme, useMediaQuery } from '@mui/material';
...
export const AddClientModal = NiceModal.create<AddClientModalProps>(({ onClientCreated }) => {
